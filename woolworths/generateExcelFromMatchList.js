...
const outputFilePath = path.join(outputFolder, "WOOLYNEWMATCHED.json");
...
const generateJsonFromMatchList = async () => {
  try {
    ...
    for (const [key, value] of Object.entries(jsonData)) {
      ...
      const productRecord = await Product.findOne({ barcode: value }).lean();
