...
# py -3 06_orchestration/coles/scripts/manage_filters.py list

# 2) List everything in new_categories of coles
# py -3 06_orchestration/coles/scripts/manage_filters.py list-new

# 3) Add a new Level-1 category under “Coles”
# py -3 06_orchestration/coles/scripts/manage_filters.py add-level1 Coles "Back To School"

# 4) Add a new Level-2 category under an existing Level-1 (“Baby”)
# py -3 06_orchestration/coles/scripts/manage_filters.py add-level2 "Baby" "New Promo Items"

# 5) Add a new Level-3 aisle under a Level-2 (“Baby Clothing”)
# py -3 06_orchestration/coles/scripts/manage_filters.py add-level3 "Baby Clothing" "Baby Socks"
